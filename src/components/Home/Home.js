    ...
    <>
      ...
      <section className="about">
        ...
        <div className="ab-p">
          ...
          <p>
            The IEEE Computational Intelligence Society (CIS) Club is a dynamic
            ...
            seminars, and hands-on projects, fostering innovation and technical
            excellence. Our club encourages research, collaboration, and
            participation in global competitions, preparing students for
            leadership in AI-driven industries. Through networking and
            mentorship, we connect members with industry experts and academic
            leaders, creating opportunities for career growth and skill
            development. Whether you’re a beginner or an enthusiast, the CIS
            Club is your gateway to exploring the exciting world of
      ...
      <section className="mission">
        <main>
          ...
          <section className="main-content">
            ...
            <p>
              <b style={{ fontSize: "2.4em" }} className="h1">
                Our mission:
              </b>
